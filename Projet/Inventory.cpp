...
void Inventory::createTotalItemsList(void)
{
	...
	totalItemsList_.push_back(std::make_shared<Item>("chaise", "Une chaise antique", "Cette chaise est a l'envers", false));
	totalItemsList_.push_back(std::make_shared<Item>("tobogan", "Un misterieux tobogan", "Ce tobogan est mauve", false));
	...
	totalItemsList_.push_back(std::make_shared<Item>("cle", "Une cle  du pouvoir", "Cette cle donne acces a la salle secrete"));
}
